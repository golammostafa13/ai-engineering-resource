...
def generate_notebook():
        ...
        "cells": [
            ...
            # Step 3: Embed
            {
                ...
                "source": [
                    ...
                    "`all-MiniLM-L6-v2` is a free, fast embedding model (384 dimensions). ",
                    "It converts any text into a list of 384 numbers that captures its meaning."
                ]
            },
            {
                "cell_type": "code",
    ...
    with open("module4_rag_colab.ipynb", "w") as f:
        json.dump(notebook, f, indent=2)
    print("✅ Notebook 'module4_rag_colab.ipynb' generated!")
